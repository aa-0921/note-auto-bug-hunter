...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const topics = [
      ...
      // 追加：元キーワードの趣向に則した「一見不可能」でクリックしたくなるタイトル
      '「1日5分」しか動かないのに、月収が増え続ける仕組みの正体',
      '寝ている間の収入が、起きているときの給料を超えた話',
      '「手を動かす」を禁止したら、成果が3倍になった理由',
      '「時間が足りない」が嘘になる、1回の設定で終わる仕組み',
      '1回の設定で、1年分のコンテンツが勝手に投稿され続ける方法',
      '副業時間を「半分」にしたら、収入が2倍になった逆説',
      'スプレッドシート1枚で、会社の業務が全部回り始めた話',
      'メール返信を「見ない」にしたら、評価が上がった理由',
      'SNS投稿を「自分で書かない」と決めたら、フォロワーが増えた方法',
      '「1本の柱」を捨てた瞬間、収益源が5つに増えた仕組み',
      '週末しか働かないのに月10万が「当たり前」になった設定',
      '「誰でもできる」と言われて試したら、本当に不労所得が始まった',
      '「働かない」と宣言した翌月、収入が増えていた理由',
      '1時間の作業で、1週間分のタスクが「消える」技術',
      '「時間は増やせない」を信じていた私が、1日を48時間にした方法',
      '「失敗する」前提で始めた自動化が、なぜか全部うまくいった話',
      '収益が「止まれない」仕組みを、意図せず作ってしまった手順',
      'AIに「全部任せた」のに、クオリティが上がった不可解な理由',
      '「時間の価値」を10倍にしたのは、働き方ではなく1つの捨て方だった',
      '「1分を24時間に」を実現した人が、絶対に言わない秘密',
    ];
    ...
    const patterns = [
      ...
      '読者の不安を先回りして解消する構成',
      'リスクと対策をセットで提示する構成',
      // 追加：一見不可能に見える見出しパターン（元キーワードの趣向に則す）
      '【1日5分しか動かないのに】月収が増え続ける仕組みの正体',
      '【寝ている間の収入が】起きているときの給料を超えた話',
      '【手を動かすを禁止したら】成果が3倍になった理由',
      '【時間が足りないが嘘になる】1回の設定で終わる仕組み',
      '【1回の設定で】1年分のコンテンツが勝手に投稿され続ける方法',
      '【副業時間を半分にしたら】収入が2倍になった逆説',
      '【スプレッドシート1枚で】会社の業務が全部回り始めた話',
      '【メール返信を見ないにしたら】評価が上がった理由',
      '【自分で書かないと決めたら】フォロワーが増えたSNS術',
      '【1本の柱を捨てた瞬間】収益源が5つに増えた仕組み',
      '【週末しか働かないのに】月10万が当たり前になった設定',
      '【誰でもできると試したら】本当に不労所得が始まった',
      '【働かないと宣言した翌月】収入が増えていた理由',
      '【1時間の作業で】1週間分のタスクが消える技術',
      '【時間は増やせないを信じていた私が】1日を48時間にした方法',
      '【失敗する前提で始めた自動化が】なぜか全部うまくいった話',
      '【意図せず作ってしまった】収益が止まれない仕組みの手順',
      '【AIに全部任せたのに】クオリティが上がった不可解な理由',
      '【働き方ではなく1つの捨て方で】時間の価値を10倍にした話',
      '【1分を24時間に実現した人が】絶対に言わない秘密',
    ];
